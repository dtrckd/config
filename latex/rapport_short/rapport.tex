...
\end{minipage}
\caption{un echantillons de bruit et sa densité de probabilité gaussienne}
\end{figure}

% tableau resised (box)
% with title and flottant ([h)
\begin{table}[h]
\caption{Caractéristique de différentes version de l'USRP}
\resizebox{\textwidth}{!}{
